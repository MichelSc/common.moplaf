/**
 */
package com.misc.common.moplaf.solver.solverscip.provider;
...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.solver.solverscip.SolverScip} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolverScipItemProvider extends SolverLpItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SolverScipItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SolverScip)object).getCode();
		return label == null || label.length() == 0 ?
			getString("_UI_SolverScip_type") :
			getString("_UI_SolverScip_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SolverScip.class)) {
	...
	public ResourceLocator getResourceLocator() {
		return SolverscipEditPlugin.INSTANCE;
	}

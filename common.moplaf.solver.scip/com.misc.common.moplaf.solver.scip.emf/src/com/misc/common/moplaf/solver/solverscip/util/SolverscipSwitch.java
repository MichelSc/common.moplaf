 ...
 * @generated
 */
public class SolverscipSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SolverscipPackage.SOLVER_SCIP: {
				SolverScip solverScip = (SolverScip)theEObject;
				T result = caseSolverScip(solverScip);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Solver Scip</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Solver Scip</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSolverScip(SolverScip object) {
		return null;
	}

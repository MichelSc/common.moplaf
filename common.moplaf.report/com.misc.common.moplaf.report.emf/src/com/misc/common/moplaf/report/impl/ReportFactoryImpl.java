...
public class ReportFactoryImpl extends EFactoryImpl implements ReportFactory {
	 ...
	 * @generated
	 */
	public ReportRenderFormat createReportRenderFormatFromString(EDataType eDataType, String initialValue) {
		ReportRenderFormat result = ReportRenderFormat.get(initialValue);

...
public class GisOsrmPackageImpl extends EPackageImpl implements GisOsrmPackage {
	 ...
	 * @generated
	 */
	private EClass gisPinpointerOsrmNearestEClass = null;
	 ...
	 * @generated
	 */
	public EClass getGisPinpointerOsrmNearest() {
		return gisPinpointerOsrmNearestEClass;
	}
	...
	public void initializePackageContents() {
		...
		gisPinpointerOsrmNearestEClass.getESuperTypes().add(theGisPackage.getGisLocationPinpointer());
		...
		initEAttribute(getGisDistanceMatrixCalculatorOsrmManyToMany_Path(), ecorePackage.getEString(), "Path", "/table/v1", 0, 1, GisDistanceMatrixCalculatorOsrmManyToMany.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

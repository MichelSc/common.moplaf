...
public class TableGroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DatasetloadPackage.Literals.TABLE_GROUP__NAME,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TableGroup"));
	}
	...
	public class TableGroupLoadCommand extends LoadCommand{
		private TableGroup tableGroup;
		
		// constructor
		public TableGroupLoadCommand(TableGroup aTableGroup)	{
			super();
			this.tableGroup = aTableGroup;
			String tmp = "Load the table group";
	...
	public Command createCommand(Object object, EditingDomain domain,
		...
		if ( commandClass == LoadCommand.class){
			return new TableGroupLoadCommand((TableGroup) object); 
		}

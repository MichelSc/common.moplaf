		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableRow_RowNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableRow_RowNumber_feature", "_UI_TableRow_type"),
				 DatasetloadPackage.Literals.TABLE_ROW__ROW_NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addNewRowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableRow_NewRow_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableRow_NewRow_feature", "_UI_TableRow_type"),
				 DatasetloadPackage.Literals.TABLE_ROW__NEW_ROW,
				 true,
				 false,
				 false,

...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.datasetload.DataSource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataSourceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DatasetloadPackage.Literals.DATA_SOURCE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DatasetloadPackage.Literals.DATA_SOURCE__CONNECTED,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataSource.class)) {
			case DatasetloadPackage.DATA_SOURCE__NAME:
			case DatasetloadPackage.DATA_SOURCE__CONNECTED:

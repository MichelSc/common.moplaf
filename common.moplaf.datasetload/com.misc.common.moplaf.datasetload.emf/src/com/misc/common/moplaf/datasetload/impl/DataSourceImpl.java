 ...
 * <ul>
 *   <li>{@link com.misc.common.moplaf.datasetload.impl.DataSourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.misc.common.moplaf.datasetload.impl.DataSourceImpl#isConnected <em>Connected</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DataSourceImpl extends MinimalEObjectImpl.Container implements DataSource {
	...
	protected EClass eStaticClass() {
		return DatasetloadPackage.Literals.DATA_SOURCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasetloadPackage.DATA_SOURCE__NAME, oldName, name));
	}
	...
	public void setConnected(boolean newConnected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasetloadPackage.DATA_SOURCE__CONNECTED, oldConnected, connected));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DatasetloadPackage.DATA_SOURCE___CONNECT:
				connect();
				return null;
			case DatasetloadPackage.DATA_SOURCE___DISCONNECT:
				disconnect();
				return null;
			case DatasetloadPackage.DATA_SOURCE___LOAD_TABLE_IMPL__TABLE:
				loadTableImpl((Table)arguments.get(0));
				return null;
		}

...
public class JobclientPackageImpl extends EPackageImpl implements JobclientPackage {
	 ...
	 * @generated
	 */
	public EOperation getJobEngine__SubmitJob__JobRemote() {
	 ...
	 * @generated
	 */
	public EOperation getJobEngine__GetJob__int() {
	...
	public void createPackageContents() {
		...
		createEOperation(jobEngineEClass, JOB_ENGINE___SUBMIT_JOB__JOBREMOTE);
		createEOperation(jobEngineEClass, JOB_ENGINE___GET_JOB__INT);
	...
	public void initializePackageContents() {
		...
		initEReference(getJobRemote_HandlingEngine(), this.getJobEngine(), this.getJobEngine_SubmittedJobs(), "HandlingEngine", null, 0, 1, JobRemote.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getJobEngine_SubmittedJobs(), this.getJobRemote(), this.getJobRemote_HandlingEngine(), "SubmittedJobs", null, 0, -1, JobEngine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getJobEngine__SubmitJob__JobRemote(), ecorePackage.getEInt(), "submitJob", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getJobRemote(), "job", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getJobEngine__GetJob__int(), this.getJobRemote(), "getJob", 0, 1, IS_UNIQUE, IS_ORDERED);

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Key Indicator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class KeyIndicatorImpl extends MinimalEObjectImpl.Container implements KeyIndicator {
	...
	protected EClass eStaticClass() {
		return JobPackage.Literals.KEY_INDICATOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JobPackage.KEY_INDICATOR__NAME, oldName, name));
	}

 ...
 * @generated
 */
public class SetterStructuralFeatureItemProvider 
	 ...
	 * @generated
	 */
	public SetterStructuralFeatureItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetterStructuralFeature_FeatureToSet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetterStructuralFeature_FeatureToSet_feature", "_UI_SetterStructuralFeature_type"),
				 JobPackage.Literals.SETTER_STRUCTURAL_FEATURE__FEATURE_TO_SET,
				 false,
				 false,
				 false,
				 null,

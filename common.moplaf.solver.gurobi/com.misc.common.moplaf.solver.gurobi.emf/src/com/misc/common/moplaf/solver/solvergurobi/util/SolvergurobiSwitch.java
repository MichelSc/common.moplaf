 ...
 * @generated
 */
public class SolvergurobiSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SolvergurobiPackage.SOLVER_GUROBI: {
				SolverGurobi solverGurobi = (SolverGurobi)theEObject;
				T result = caseSolverGurobi(solverGurobi);
				if (result == null) result = caseSolverLp(solverGurobi);
				if (result == null) result = caseILpWriter(solverGurobi);
				if (result == null) result = caseSolver(solverGurobi);
				if (result == null) result = caseSolverLpParams(solverGurobi);
				if (result == null) result = caseSolutionProvider(solverGurobi);
				if (result == null) result = caseSolverParams(solverGurobi);
				if (result == null) result = caseRun(solverGurobi);
				if (result == null) result = caseIGeneratorTool(solverGurobi);
				if (result == null) result = caseSolutionProviderParams(solverGurobi);
				if (result == null) result = caseRunParams(solverGurobi);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Solver Gurobi</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Solver Gurobi</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSolverGurobi(SolverGurobi object) {
		return null;
	}

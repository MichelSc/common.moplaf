...
/**
 */
package com.misc.common.moplaf.dbsynch.dbsynchderby.util;
 ...
 * @generated
 */
public class DbsynchderbySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static DbsynchderbyPackage modelPackage;
	 ...
	 * @generated
	 */
	public DbsynchderbySwitch() {
		if (modelPackage == null) {
			modelPackage = DbsynchderbyPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DbsynchderbyPackage.DATA_SOURCE_JDBC_DERBY_EMBEDDED: {
				DataSourceJdbcDerbyEmbedded dataSourceJdbcDerbyEmbedded = (DataSourceJdbcDerbyEmbedded)theEObject;

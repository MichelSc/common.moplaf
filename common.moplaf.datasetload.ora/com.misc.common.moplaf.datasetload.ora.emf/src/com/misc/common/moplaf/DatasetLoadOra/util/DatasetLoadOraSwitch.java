 ...
 * @generated
 */
public class DatasetLoadOraSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static DatasetLoadOraPackage modelPackage;
	 ...
	 * @generated
	 */
	public DatasetLoadOraSwitch() {
		if (modelPackage == null) {
			modelPackage = DatasetLoadOraPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DatasetLoadOraPackage.DATASET_LOAD_JDBC_ORA_THIN: {
				DatasetLoadJdbcOraThin datasetLoadJdbcOraThin = (DatasetLoadJdbcOraThin)theEObject;
				T result = caseDatasetLoadJdbcOraThin(datasetLoadJdbcOraThin);
				if (result == null) result = caseDataSourceJdbc(datasetLoadJdbcOraThin);
				if (result == null) result = caseDataSource(datasetLoadJdbcOraThin);

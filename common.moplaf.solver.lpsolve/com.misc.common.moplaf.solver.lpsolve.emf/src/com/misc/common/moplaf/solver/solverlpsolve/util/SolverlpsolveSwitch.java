 ...
 * @generated
 */
public class SolverlpsolveSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SolverlpsolvePackage modelPackage;
	 ...
	 * @generated
	 */
	public SolverlpsolveSwitch() {
		if (modelPackage == null) {
			modelPackage = SolverlpsolvePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SolverlpsolvePackage.SOLVER_LP_SOLVE: {
				SolverLpSolve solverLpSolve = (SolverLpSolve)theEObject;
				T result = caseSolverLpSolve(solverLpSolve);
				if (result == null) result = caseSolverLp(solverLpSolve);
				if (result == null) result = caseILpWriter(solverLpSolve);
				if (result == null) result = caseSolver(solverLpSolve);
				if (result == null) result = caseSolverLpParams(solverLpSolve);
				if (result == null) result = caseSolutionProvider(solverLpSolve);
				if (result == null) result = caseSolverParams(solverLpSolve);
				if (result == null) result = caseRun(solverLpSolve);
				if (result == null) result = caseIGeneratorTool(solverLpSolve);
				if (result == null) result = caseSolutionProviderParams(solverLpSolve);
				if (result == null) result = caseRunParams(solverLpSolve);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Solver Lp Solve</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Solver Lp Solve</em>'.

 ...
 * @generated
 */
public class LocalSearchFactoryImpl extends EFactoryImpl implements LocalSearchFactory {
	/**
	 ...
	 * @generated
	 */
	public static LocalSearchFactory init() {
		try {
			LocalSearchFactory theLocalSearchFactory = (LocalSearchFactory)EPackage.Registry.INSTANCE.getEFactory(LocalSearchPackage.eNS_URI);
			if (theLocalSearchFactory != null) {
				return theLocalSearchFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new LocalSearchFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public LocalSearchPackage getLocalSearchPackage() {
		return (LocalSearchPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static LocalSearchPackage getPackage() {
		return LocalSearchPackage.eINSTANCE;
	}

} //LocalSearchFactoryImpl

 ...
 * @generated
 */
public class DatasetLoadMariaDbSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static DatasetLoadMariaDbPackage modelPackage;
	 ...
	 * @generated
	 */
	public DatasetLoadMariaDbSwitch() {
		if (modelPackage == null) {
			modelPackage = DatasetLoadMariaDbPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DatasetLoadMariaDbPackage.DATASET_LOAD_JDBC_MARIA_DB: {
				DatasetLoadJdbcMariaDb datasetLoadJdbcMariaDb = (DatasetLoadJdbcMariaDb)theEObject;
				T result = caseDatasetLoadJdbcMariaDb(datasetLoadJdbcMariaDb);
				if (result == null) result = caseDataSourceJdbc(datasetLoadJdbcMariaDb);
				if (result == null) result = caseDataSource(datasetLoadJdbcMariaDb);

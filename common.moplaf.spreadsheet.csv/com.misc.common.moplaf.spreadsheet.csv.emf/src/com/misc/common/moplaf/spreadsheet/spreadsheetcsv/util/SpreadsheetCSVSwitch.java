 ...
 * @generated
 */
public class SpreadsheetCSVSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SpreadsheetCSVPackage.SPREADSHEET_CSV: {
				SpreadsheetCSV spreadsheetCSV = (SpreadsheetCSV)theEObject;
				T result = caseSpreadsheetCSV(spreadsheetCSV);
				if (result == null) result = caseSpreadsheetReaderWriter(spreadsheetCSV);
				if (result == null) result = caseFileReaderWriter(spreadsheetCSV);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Spreadsheet CSV</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Spreadsheet CSV</em>'.

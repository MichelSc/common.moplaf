...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.macroplanner.solver.LPSupplyBucket} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LPSupplyBucketItemProvider extends LPTimeBucketItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LPSupplyBucketItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LPSupplyBucket_ProductBucket_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LPSupplyBucket_ProductBucket_feature", "_UI_LPSupplyBucket_type"),
				 MacroPlannerSolverPackage.Literals.LP_SUPPLY_BUCKET__PRODUCT_BUCKET,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MacroPlannerSolverPackage.Literals.LP_SUPPLY_BUCKET__SUPPLIED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MacroPlannerSolverPackage.Literals.LP_SUPPLY_BUCKET__SUPPLIED,

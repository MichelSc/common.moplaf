...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.macroplanner.solver.LPRoutingBucket} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LPRoutingBucketItemProvider extends LPTimeBucketItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LPRoutingBucketItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MacroPlannerSolverPackage.Literals.LP_ROUTING_BUCKET__PRODUCTS);
			childrenFeatures.add(MacroPlannerSolverPackage.Literals.LP_ROUTING_BUCKET__RESOURCES);
			childrenFeatures.add(MacroPlannerSolverPackage.Literals.LP_ROUTING_BUCKET__PLANNED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MacroPlannerSolverPackage.Literals.LP_ROUTING_BUCKET__PRODUCTS,
				 MacroPlannerSolverFactory.eINSTANCE.createLPRoutingBucketProduct()));

		newChildDescriptors.add
			(createChildParameter
				(MacroPlannerSolverPackage.Literals.LP_ROUTING_BUCKET__RESOURCES,
				 MacroPlannerSolverFactory.eINSTANCE.createLPRoutingBucketResource()));

		newChildDescriptors.add
			(createChildParameter
				(MacroPlannerSolverPackage.Literals.LP_ROUTING_BUCKET__PLANNED,

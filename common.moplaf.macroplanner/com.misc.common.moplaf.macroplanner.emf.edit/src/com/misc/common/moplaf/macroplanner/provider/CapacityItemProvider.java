		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Capacity_SupplyChainLimits_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Capacity_SupplyChainLimits_feature", "_UI_Capacity_type"),
				 MacroPlannerPackage.Literals.CAPACITY__SUPPLY_CHAIN_LIMITS,
				 true,
				 false,
				 true,
				 null,

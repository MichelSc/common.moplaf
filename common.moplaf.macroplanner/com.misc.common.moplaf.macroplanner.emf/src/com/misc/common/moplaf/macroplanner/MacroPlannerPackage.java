...
public interface MacroPlannerPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SUPPLY__LOCATION_PRODUCT = 4;
	 ...
	 * @ordered
	 */
	int AVAILABILITY__LOCATION_RESOURCE = 6;
	 ...
	 * @ordered
	 */
	int AVAILABILITY_FEATURE_COUNT = 7;
	 ...
	 * @ordered
	 */
	int CAPACITY__LOCATION_PRODUCT = 6;

...
import com.misc.common.moplaf.time.continuous.impl.ContinuousPackageImpl;
...
public class DiscretePackageImpl extends EPackageImpl implements DiscretePackage {
	...
	public static DiscretePackage init() {
		...
		ContinuousPackageImpl theContinuousPackage = (ContinuousPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(ContinuousPackage.eNS_URI) instanceof ContinuousPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(ContinuousPackage.eNS_URI) : ContinuousPackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EOperation getTimeLine__GetSecondsIntersection__Date_Date_Date_Date() {
	...
	public EReference getTimeBucket_Next() {
		return (EReference)timeBucketEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getTimeBucket_Description() {
		return (EAttribute)timeBucketEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(timeLineEClass, TIME_LINE___GET_SECONDS_INTERSECTION__DATE_DATE_DATE_DATE);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getTimeLine__Iterator__Date_Date_boolean(), this.getBucketIterator(), "iterator", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getTimeLine__GetSecondsIntersection__Date_Date_Date_Date(), ecorePackage.getEInt(), "getSecondsIntersection", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDate(), "from1", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDate(), "to1", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDate(), "from2", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDate(), "to2", 0, 1, IS_UNIQUE, IS_ORDERED);

...
public class AmountImpulsionAtomicImpl extends AmountImpulsionImpl implements AmountImpulsionAtomic {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == DistributionEventsProvider.class) {
			switch (baseOperationID) {
				case ContinuousPackage.DISTRIBUTION_EVENTS_PROVIDER___REFRESH_EVENT: return ContinuousPackage.AMOUNT_IMPULSION_ATOMIC___REFRESH_EVENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ContinuousPackage.AMOUNT_IMPULSION_ATOMIC___REFRESH_EVENT:
				refreshEvent();
				return null;
		}

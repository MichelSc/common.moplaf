 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.common.moplaf.time.continuous.impl.AmountAbsoluteAtomicImpl#getDistribution <em>Distribution</em>}</li>
 *   <li>{@link com.misc.common.moplaf.time.continuous.impl.AmountAbsoluteAtomicImpl#getProvidedEvents <em>Provided Events</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AmountAbsoluteAtomicImpl extends AmountAbsoluteImpl implements AmountAbsoluteAtomic {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ContinuousPackage.AMOUNT_ABSOLUTE_ATOMIC__DISTRIBUTION:
				if (resolve) return getDistribution();
				return basicGetDistribution();
			case ContinuousPackage.AMOUNT_ABSOLUTE_ATOMIC__PROVIDED_EVENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DistributionEventsProvider.class) {
			switch (derivedFeatureID) {
				case ContinuousPackage.AMOUNT_ABSOLUTE_ATOMIC__DISTRIBUTION: return ContinuousPackage.DISTRIBUTION_EVENTS_PROVIDER__DISTRIBUTION;
				case ContinuousPackage.AMOUNT_ABSOLUTE_ATOMIC__PROVIDED_EVENTS: return ContinuousPackage.DISTRIBUTION_EVENTS_PROVIDER__PROVIDED_EVENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DistributionEventsProvider.class) {
			switch (baseFeatureID) {
				case ContinuousPackage.DISTRIBUTION_EVENTS_PROVIDER__DISTRIBUTION: return ContinuousPackage.AMOUNT_ABSOLUTE_ATOMIC__DISTRIBUTION;
				case ContinuousPackage.DISTRIBUTION_EVENTS_PROVIDER__PROVIDED_EVENTS: return ContinuousPackage.AMOUNT_ABSOLUTE_ATOMIC__PROVIDED_EVENTS;
				default: return -1;
			}
		}

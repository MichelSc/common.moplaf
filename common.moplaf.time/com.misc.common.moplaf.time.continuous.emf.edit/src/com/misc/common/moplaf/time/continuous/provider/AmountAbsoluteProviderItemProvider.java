...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.time.continuous.AmountAbsoluteProvider} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AmountAbsoluteProviderItemProvider extends EventProviderItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AmountAbsoluteProviderItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		Date labelValue = ((AmountAbsoluteProvider)object).getMoment();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_AmountAbsoluteProvider_type") :
			getString("_UI_AmountAbsoluteProvider_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.time.continuous.calc.CalcEventMoment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalcEventMomentItemProvider extends PropagatorFunctionDistributionEventItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CalcEventMomentItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalcEventMoment_ConcreteParent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalcEventMoment_ConcreteParent_feature", "_UI_CalcEventMoment_type"),
				 TimeContinuousCalcPackage.Literals.CALC_EVENT_MOMENT__CONCRETE_PARENT,
				 false,
				 false,
				 false,
				 null,

...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.time.continuous.calc.CalcDistributionInitialization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalcDistributionInitializationItemProvider extends PropagatorFunctionDistributionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CalcDistributionInitializationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalcDistributionInitialization_ConcreteParent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalcDistributionInitialization_ConcreteParent_feature", "_UI_CalcDistributionInitialization_type"),
				 TimeContinuousCalcPackage.Literals.CALC_DISTRIBUTION_INITIALIZATION__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,

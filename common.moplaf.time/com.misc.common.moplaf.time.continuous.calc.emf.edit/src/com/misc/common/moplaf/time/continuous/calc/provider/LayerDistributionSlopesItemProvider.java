...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.time.continuous.calc.LayerDistributionSlopes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerDistributionSlopesItemProvider extends PropagatorFunctionDistributionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LayerDistributionSlopesItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LayerDistributionSlopes_ConcreteParent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LayerDistributionSlopes_ConcreteParent_feature", "_UI_LayerDistributionSlopes_type"),
				 TimeContinuousCalcPackage.Literals.LAYER_DISTRIBUTION_SLOPES__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAntecedentCalcDistributionSequencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LayerDistributionSlopes_AntecedentCalcDistributionSequence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LayerDistributionSlopes_AntecedentCalcDistributionSequence_feature", "_UI_LayerDistributionSlopes_type"),
				 TimeContinuousCalcPackage.Literals.LAYER_DISTRIBUTION_SLOPES__ANTECEDENT_CALC_DISTRIBUTION_SEQUENCE,
				 true,
				 false,
				 true,
				 null,

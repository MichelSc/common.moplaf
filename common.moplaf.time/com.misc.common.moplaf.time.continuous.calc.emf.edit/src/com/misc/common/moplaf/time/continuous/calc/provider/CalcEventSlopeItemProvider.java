...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.time.continuous.calc.CalcEventSlope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalcEventSlopeItemProvider extends PropagatorFunctionDistributionEventItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CalcEventSlopeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalcEventSlope_ConcreteParent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalcEventSlope_ConcreteParent_feature", "_UI_CalcEventSlope_type"),
				 TimeContinuousCalcPackage.Literals.CALC_EVENT_SLOPE__CONCRETE_PARENT,
				 false,
				 false,
				 false,
				 null,

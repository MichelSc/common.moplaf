...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.time.continuous.calc.LayerDistributionAmounts} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerDistributionAmountsItemProvider extends PropagatorFunctionDistributionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LayerDistributionAmountsItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LayerDistributionAmounts_ConcreteParent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LayerDistributionAmounts_ConcreteParent_feature", "_UI_LayerDistributionAmounts_type"),
				 TimeContinuousCalcPackage.Literals.LAYER_DISTRIBUTION_AMOUNTS__CONCRETE_PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAntecedentLayerDistributionSlopesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LayerDistributionAmounts_AntecedentLayerDistributionSlopes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LayerDistributionAmounts_AntecedentLayerDistributionSlopes_feature", "_UI_LayerDistributionAmounts_type"),
				 TimeContinuousCalcPackage.Literals.LAYER_DISTRIBUTION_AMOUNTS__ANTECEDENT_LAYER_DISTRIBUTION_SLOPES,
				 true,
				 false,
				 true,
				 null,

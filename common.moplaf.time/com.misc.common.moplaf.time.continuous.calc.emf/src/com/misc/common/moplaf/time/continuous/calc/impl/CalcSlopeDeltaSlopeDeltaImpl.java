 ...
 * @generated
 */
public class CalcSlopeDeltaSlopeDeltaImpl extends CalcEventSlopeImpl implements CalcSlopeDeltaSlopeDelta {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected CalcSlopeDeltaSlopeDeltaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TimeContinuousCalcPackage.Literals.CALC_SLOPE_DELTA_SLOPE_DELTA;
	}
	
	protected static Bindings distributionEventBindings = Bindings.constructBindings()
			.addOutboundBinding(TimeContinuousPackage.Literals.SLOPE_DELTA__SLOPE_DELTA);
	...
	public void doRefresh() {
		SlopeDelta event = (SlopeDelta) this.getDistributionEvent();
		event.refreshSlopeDelta();
	}

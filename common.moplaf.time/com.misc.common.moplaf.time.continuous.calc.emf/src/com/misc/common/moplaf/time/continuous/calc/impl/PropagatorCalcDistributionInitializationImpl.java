...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Propagator Calc Distribution Initialization</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.misc.common.moplaf.time.continuous.calc.impl.PropagatorCalcDistributionInitializationImpl#getConcreteParent <em>Concrete Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropagatorCalcDistributionInitializationImpl extends PropagatorFunctionDistributionImpl implements PropagatorCalcDistributionInitialization {
	/**
	 ...
	 * @generated
	 */
	protected PropagatorCalcDistributionInitializationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TimeContinuousCalcPackage.Literals.PROPAGATOR_CALC_DISTRIBUTION_INITIALIZATION;
	}
		...
		if (concreteParent != null && concreteParent.eIsProxy()) {
			...
			if (concreteParent != oldConcreteParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TimeContinuousCalcPackage.PROPAGATOR_CALC_DISTRIBUTION_INITIALIZATION__CONCRETE_PARENT, oldConcreteParent, concreteParent));
			}
		}
	...
	public void setConcreteParent(PropagatorScopeDistribution newConcreteParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimeContinuousCalcPackage.PROPAGATOR_CALC_DISTRIBUTION_INITIALIZATION__CONCRETE_PARENT, oldConcreteParent, concreteParent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TimeContinuousCalcPackage.PROPAGATOR_CALC_DISTRIBUTION_INITIALIZATION__CONCRETE_PARENT:

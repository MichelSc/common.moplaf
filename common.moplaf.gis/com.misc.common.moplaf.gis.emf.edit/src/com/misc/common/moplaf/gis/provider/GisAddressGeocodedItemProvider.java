...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.gis.GisAddressGeocoded} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GisAddressGeocodedItemProvider extends GisCoordinatesItemProvider {
	 ...
	 * @generated
	 */
	public GisAddressGeocodedItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GisAddressGeocoded_Score_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GisAddressGeocoded_Score_feature", "_UI_GisAddressGeocoded_type"),
				 GisPackage.Literals.GIS_ADDRESS_GEOCODED__SCORE,
				 true,
				 false,
				 false,

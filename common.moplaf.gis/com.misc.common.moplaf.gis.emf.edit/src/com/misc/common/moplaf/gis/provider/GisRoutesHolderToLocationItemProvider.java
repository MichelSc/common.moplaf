		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GisRoutesHolderToLocation_Location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GisRoutesHolderToLocation_Location_feature", "_UI_GisRoutesHolderToLocation_type"),
				 GisPackage.Literals.GIS_ROUTES_HOLDER_TO_LOCATION__LOCATION,
				 true,
				 false,
				 true,
				 null,

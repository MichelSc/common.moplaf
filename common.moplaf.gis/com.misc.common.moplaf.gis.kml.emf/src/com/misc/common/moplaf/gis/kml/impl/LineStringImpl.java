 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.common.moplaf.gis.kml.impl.LineStringImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LineStringImpl extends GeometryImpl implements LineString {
	...
	public EList<Coordinates> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EDataTypeUniqueEList<Coordinates>(Coordinates.class, this, KmlPackage.LINE_STRING__COORDINATES);
		}
		return coordinates;
	}

...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.gis.kml.Geometry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeometryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Geometry_Color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Geometry_Color_feature", "_UI_Geometry_type"),
				 KmlPackage.Literals.GEOMETRY__COLOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Geometry_type") + " " + geometry.getColor();
	}

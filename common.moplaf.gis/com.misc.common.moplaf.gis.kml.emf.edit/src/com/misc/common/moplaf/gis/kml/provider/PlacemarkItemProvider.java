...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.gis.kml.Placemark} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlacemarkItemProvider extends FeatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PlacemarkItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((Placemark)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Placemark_type") :
			getString("_UI_Placemark_type") + " " + label;
	}

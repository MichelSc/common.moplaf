...
public class SpreadsheetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SpreadsheetPackage.SPREADSHEET: {
				Spreadsheet spreadsheet = (Spreadsheet)theEObject;
				T result = caseSpreadsheet(spreadsheet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpreadsheetPackage.SHEET: {
				Sheet sheet = (Sheet)theEObject;
				T result = caseSheet(sheet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpreadsheetPackage.ROW: {
				Row row = (Row)theEObject;
				T result = caseRow(row);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpreadsheetPackage.COLUMN: {
			...
			case SpreadsheetPackage.SPREADSHEET_READER_WRITER: {
				SpreadsheetReaderWriter spreadsheetReaderWriter = (SpreadsheetReaderWriter)theEObject;
				T result = caseSpreadsheetReaderWriter(spreadsheetReaderWriter);
				if (result == null) result = caseFileReaderWriter(spreadsheetReaderWriter);
				if (result == null) result = caseFileHandler(spreadsheetReaderWriter);
				if (result == null) result = caseFileOwner(spreadsheetReaderWriter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

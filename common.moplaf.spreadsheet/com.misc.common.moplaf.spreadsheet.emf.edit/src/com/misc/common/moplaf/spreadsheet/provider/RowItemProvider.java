...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.spreadsheet.Row} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Row_Sheet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Row_Sheet_feature", "_UI_Row_type"),
				 SpreadsheetPackage.Literals.ROW__SHEET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRowIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Row_RowIndex_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Row_RowIndex_feature", "_UI_Row_type"),
				 SpreadsheetPackage.Literals.ROW__ROW_INDEX,
				 true,
				 false,
				 false,

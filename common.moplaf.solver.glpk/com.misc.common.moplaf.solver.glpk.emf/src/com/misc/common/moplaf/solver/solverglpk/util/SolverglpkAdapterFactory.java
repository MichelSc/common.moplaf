 ...
 * @generated
 */
public class SolverglpkAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public SolverglpkAdapterFactory() {
	 ...
	 * @generated
	 */
	protected SolverglpkSwitch<Adapter> modelSwitch =
		new SolverglpkSwitch<Adapter>() {
			@Override
			public Adapter caseSolverGLPK(SolverGLPK object) {
				return createSolverGLPKAdapter();
			}
			@Override
			public Adapter caseSolverGLPKParams(SolverGLPKParams object) {
				return createSolverGLPKParamsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.misc.common.moplaf.solver.solverglpk.SolverGLPKParams <em>Solver GLPK Params</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

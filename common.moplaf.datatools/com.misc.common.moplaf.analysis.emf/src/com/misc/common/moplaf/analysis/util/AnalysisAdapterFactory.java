...
public class AnalysisAdapterFactory extends AdapterFactoryImpl {
	...
	protected AnalysisSwitch<Adapter> modelSwitch =
		new AnalysisSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAnalysisHolder(AnalysisHolder object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.misc.common.moplaf.analysis.AnalysisHolder <em>Holder</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

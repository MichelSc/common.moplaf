...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.datatools.FilterAttributeInt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilterAttributeIntItemProvider extends FilterAttributeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FilterAttributeIntItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((FilterAttributeInt)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_FilterAttributeInt_type") :
			getString("_UI_FilterAttributeInt_type") + " " + label;
	}

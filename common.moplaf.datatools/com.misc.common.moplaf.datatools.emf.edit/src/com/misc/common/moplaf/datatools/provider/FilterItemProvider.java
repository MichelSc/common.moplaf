...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.datatools.Filter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilterItemProvider extends DataToolAbstractItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Filter_Enabled_feature", "_UI_Filter_type"),
				 DatatoolsPackage.Literals.FILTER__ENABLED,
				 true,
				 false,
				 false,
	...
	protected void addNegatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Filter_Negated_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Filter_Negated_feature", "_UI_Filter_type"),
				 DatatoolsPackage.Literals.FILTER__NEGATED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Filter_FilteredType_feature", "_UI_Filter_type"),
				 DatatoolsPackage.Literals.FILTER__FILTERED_TYPE,
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		String label = ((Filter)object).getDescription();

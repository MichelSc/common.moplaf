 ...
 * @generated
 */
public class CategoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemGridsProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addColumnizersPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_Elements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_Elements_feature", "_UI_Category_type"),
				 DatatoolsPackage.Literals.CATEGORY__ELEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNbElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_NbElements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_NbElements_feature", "_UI_Category_type"),
				 DatatoolsPackage.Literals.CATEGORY__NB_ELEMENTS,
				 false,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Columnizers feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addColumnizersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_Columnizers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_Columnizers_feature", "_UI_Category_type"),
				 DatatoolsPackage.Literals.CATEGORY__COLUMNIZERS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatatoolsPackage.Literals.CATEGORY__SUB_CATEGORIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatatoolsPackage.Literals.CATEGORY__SUB_CATEGORIES,
	...
	public Object getGrids(Object element) {
		...
		Columnizers columnizers = cat.getColumnizers(); 
		if ( columnizers!=null ) {

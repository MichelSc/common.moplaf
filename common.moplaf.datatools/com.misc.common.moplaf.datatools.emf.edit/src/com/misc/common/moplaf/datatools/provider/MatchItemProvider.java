...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.datatools.Match} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Match_Object1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Match_Object1_feature", "_UI_Match_type"),
				 DatatoolsPackage.Literals.MATCH__OBJECT1,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addObject2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Match_Object2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Match_Object2_feature", "_UI_Match_type"),
				 DatatoolsPackage.Literals.MATCH__OBJECT2,
				 true,
				 false,
				 true,
				 null,

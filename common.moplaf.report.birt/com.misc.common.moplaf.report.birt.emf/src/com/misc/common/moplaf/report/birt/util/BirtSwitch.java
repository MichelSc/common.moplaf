...
/**
 */
package com.misc.common.moplaf.report.birt.util;
 ...
 * @generated
 */
public class BirtSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static BirtPackage modelPackage;
	...
	public BirtSwitch() {
		if (modelPackage == null) {
			modelPackage = BirtPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BirtPackage.REPORT_BIRT: {
				ReportBirt reportBirt = (ReportBirt)theEObject;
				T result = caseReportBirt(reportBirt);
				if (result == null) result = caseReportAbstract(reportBirt);

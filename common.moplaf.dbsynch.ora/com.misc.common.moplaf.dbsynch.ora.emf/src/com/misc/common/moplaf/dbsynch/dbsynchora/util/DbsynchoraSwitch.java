 ...
 * @generated
 */
public class DbsynchoraSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DbsynchoraPackage.DATA_SOURCE_JDBC_ORA_THIN: {
				DataSourceJdbcOraThin dataSourceJdbcOraThin = (DataSourceJdbcOraThin)theEObject;
				T result = caseDataSourceJdbcOraThin(dataSourceJdbcOraThin);
				if (result == null) result = caseDataSourceJdbc(dataSourceJdbcOraThin);
				if (result == null) result = caseDataSource(dataSourceJdbcOraThin);
				if (result == null) result = caseDbSynchUnitAbstract(dataSourceJdbcOraThin);

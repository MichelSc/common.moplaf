...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.gis.gisgisgraphy.GisAddressGeocoderGisgraphy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GisAddressGeocoderGisgraphyItemProvider extends GisAddressGeocoderItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GisAddressGeocoderGisgraphyItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((GisAddressGeocoderGisgraphy)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GisAddressGeocoderGisgraphy_type") :
			getString("_UI_GisAddressGeocoderGisgraphy_type") + " " + label;
	}

/**
 */
package com.misc.common.moplaf.dbsynch.dbsynchmysql.util;
 ...
 * @generated
 */
public class DbsynchmysqlSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static DbsynchmysqlPackage modelPackage;
	 ...
	 * @generated
	 */
	public DbsynchmysqlSwitch() {
		if (modelPackage == null) {
			modelPackage = DbsynchmysqlPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DbsynchmysqlPackage.DATA_SOURCE_JDBC_MY_SQL: {
				DataSourceJdbcMySql dataSourceJdbcMySql = (DataSourceJdbcMySql)theEObject;
				T result = caseDataSourceJdbcMySql(dataSourceJdbcMySql);
				if (result == null) result = caseDataSourceJdbc(dataSourceJdbcMySql);
				if (result == null) result = caseDataSource(dataSourceJdbcMySql);
				if (result == null) result = caseDbSynchUnitAbstract(dataSourceJdbcMySql);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Source Jdbc My Sql</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Source Jdbc My Sql</em>'.

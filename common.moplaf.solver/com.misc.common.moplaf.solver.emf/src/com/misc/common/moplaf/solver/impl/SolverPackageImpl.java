...
public class SolverPackageImpl extends EPackageImpl implements SolverPackage {
	 ...
	 * @generated
	 */
	public EReference getGenerator_GoalsRoot() {
	 ...
	 * @generated
	 */
	public EAttribute getGeneratorTuple_Code() {
	 ...
	 * @generated
	 */
	public EReference getGeneratorGoal_GeneratorAsRoot() {
	 ...
	 * @generated
	 */
	public EReference getGeneratorGoal_SubGoal() {
		return (EReference)generatorGoalEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getGeneratorLpGoal_LpGoalTerm() {
		return (EReference)generatorLpGoalEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getGeneratorLpGoal__ConstructTerm__GeneratorLpVar_float() {
	...
	public EOperation getGeneratorLpGoal__GetSolutionValue__Solution() {
		return generatorLpGoalEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getGeneratorLpGoalTerm() {
		return generatorLpGoalTermEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getGeneratorLpGoalTerm_Coeff() {
		return (EAttribute)generatorLpGoalTermEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGeneratorLpGoalTerm_LpVar() {
		return (EReference)generatorLpGoalTermEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getGeneratorLpGoalTerm_LpGoal() {
		return (EReference)generatorLpGoalTermEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getSolution_Var() {
	 ...
	 * @generated
	 */
	public EReference getGeneratorLpVar_LpGoalTerm() {
	 ...
	 * @generated
	 */
	public EReference getGeneratorLpCons_LpTerm() {
		return (EReference)generatorLpConsEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getGeneratorLpCons_RighHandSide() {
		return (EAttribute)generatorLpConsEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getGeneratorLpCons__ConstructTerm__GeneratorLpVar_float() {
		return generatorLpConsEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSolver_SolverBackground() {
	...
	public EAttribute getSolver_Initializing() {
		return (EAttribute)solverEClass.getEStructuralFeatures().get(23);
	}
	...
	public EReference getSolver_InitialSolution() {
		return (EReference)solverEClass.getEStructuralFeatures().get(25);
	}
	 ...
	 * @generated
	 */
	public EReference getSolutionVar_Solution() {
	...
	public EReference getSolutionVar_Var() {
		return (EReference)solutionVarEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getSolutionCons_Solution() {
	...
	public EReference getSolutionCons_Cons() {
		return (EReference)solutionConsEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(generatorEClass, GENERATOR__GOALS_ROOT);
		...
		createEReference(generatorLpVarEClass, GENERATOR_LP_VAR__LP_GOAL_TERM);
		...
		createEReference(generatorLpConsEClass, GENERATOR_LP_CONS__LP_TERM);
		createEAttribute(generatorLpConsEClass, GENERATOR_LP_CONS__RIGH_HAND_SIDE);
		createEOperation(generatorLpConsEClass, GENERATOR_LP_CONS___CONSTRUCT_TERM__GENERATORLPVAR_FLOAT);
		...
		createEAttribute(solverEClass, SOLVER__SOLVER_BACKGROUND);
		...
		createEReference(solutionEClass, SOLUTION__VAR);
		...
		createEReference(solutionVarEClass, SOLUTION_VAR__SOLUTION);
		...
		createEReference(solutionConsEClass, SOLUTION_CONS__SOLUTION);
		...
		generatorLpGoalTermEClass = createEClass(GENERATOR_LP_GOAL_TERM);
	...
	public void initializePackageContents() {
		...
		initEReference(getGenerator_GoalsRoot(), this.getGeneratorGoal(), this.getGeneratorGoal_GeneratorAsRoot(), "GoalsRoot", null, 0, -1, Generator.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGeneratorLpVar_LpGoalTerm(), this.getGeneratorLpGoalTerm(), this.getGeneratorLpGoalTerm_LpVar(), "LpGoalTerm", null, 0, -1, GeneratorLpVar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSolver_InitialSolution(), this.getSolution(), null, "InitialSolution", null, 0, 1, Solver.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSolution_Var(), this.getSolutionVar(), this.getSolutionVar_Solution(), "Var", null, 0, -1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSolution_Cons(), this.getSolutionCons(), this.getSolutionCons_Solution(), "Cons", null, 0, -1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSolutionVar_Solution(), this.getSolution(), this.getSolution_Var(), "Solution", null, 1, 1, SolutionVar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSolutionCons_Solution(), this.getSolution(), this.getSolution_Cons(), "Solution", null, 1, 1, SolutionCons.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

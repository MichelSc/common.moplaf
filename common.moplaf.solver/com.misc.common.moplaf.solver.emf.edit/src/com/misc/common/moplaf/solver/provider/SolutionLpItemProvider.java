...
public class SolutionLpItemProvider extends SolutionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SolutionLp_GoalValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SolutionLp_GoalValue_feature", "_UI_SolutionLp_type"),
				 SolverPackage.Literals.SOLUTION_LP__GOAL_VALUE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SolutionLp"));
	}

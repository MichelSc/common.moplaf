...
public class SolutionLpGoalItemProvider extends SolutionGoalItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SolutionLpGoal_OptimalValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SolutionLpGoal_OptimalValue_feature", "_UI_SolutionLpGoal_type"),
				 SolverPackage.Literals.SOLUTION_LP_GOAL__OPTIMAL_VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		SolutionLpGoal solutionLpGoal = (SolutionLpGoal)object;
		return getString("_UI_SolutionLpGoal_type") + " " + solutionLpGoal.getOptimalValue();
	}

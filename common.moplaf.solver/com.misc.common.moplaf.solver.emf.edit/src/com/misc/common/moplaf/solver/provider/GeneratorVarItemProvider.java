...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.solver.GeneratorVar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeneratorVarItemProvider
	 ...
	 * @generated
	 */
	public GeneratorVarItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeneratorVar_SelectedSolutionValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeneratorVar_SelectedSolutionValue_feature", "_UI_GeneratorVar_type"),
				 SolverPackage.Literals.GENERATOR_VAR__SELECTED_SOLUTION_VALUE,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SolverPackage.Literals.GENERATOR_VAR__SOLUTION);
		}
	...
	public String getText(Object object) {
		String label = ((GeneratorVar)object).getCode();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeneratorVar.class)) {

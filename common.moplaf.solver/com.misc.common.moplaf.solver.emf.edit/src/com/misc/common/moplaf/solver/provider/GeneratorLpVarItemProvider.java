...
public class GeneratorLpVarItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addObjectiveCoeffPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Objective Coeff feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addObjectiveCoeffPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeneratorLpVar_ObjectiveCoeff_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeneratorLpVar_ObjectiveCoeff_feature", "_UI_GeneratorLpVar_type"),
				 SolverPackage.Literals.GENERATOR_LP_VAR__OBJECTIVE_COEFF,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addLpTermPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeneratorLpVar_LpTerm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeneratorLpVar_LpTerm_feature", "_UI_GeneratorLpVar_type"),
				 SolverPackage.Literals.GENERATOR_LP_VAR__LP_TERM,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns GeneratorLpVar.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeneratorLpVar"));
	}

...
public class TimeLineImpl extends MinimalEObjectImpl.Container implements TimeLine {
	 ...
	 * @generated
	 */
	public int getSecondsIntersection(Date from1, Date to1, Date from2, Date to2) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case DiscretePackage.TIME_LINE___GET_SECONDS_INTERSECTION__DATE_DATE_DATE_DATE:
				return getSecondsIntersection((Date)arguments.get(0), (Date)arguments.get(1), (Date)arguments.get(2), (Date)arguments.get(3));
	...
	public class BucketRounder {
		...
		public void roundBucket(TimeBucket newbucket, Date sometime) {
			...
			int seconds = TimeLine.Util.getSeconds(newbucket.getBucketStart(), newbucket.getBucketEnd());
	 ...
	 */
		...
		private void refreshDependents(){
			...
			if ( partfrom!=null && partto!=null){
				partseconds = TimeLine.Util.getSecondsIntersection(this.fromDate, this.toDate, partfrom, partto);
		...
		public BucketIteratorImpl(Date aFromDate, Date aToDate, boolean naked){
			...
			if ( aFromDate!=null && aToDate!=null){
				totalseconds = TimeLine.Util.getSeconds(aFromDate, aToDate);

 ...
 * @generated
 */
public class SolverjacopSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SolverjacopPackage.SOLVER_JACOP: {
				SolverJacop solverJacop = (SolverJacop)theEObject;
				T result = caseSolverJacop(solverJacop);
				if (result == null) result = caseSolverCp(solverJacop);
				if (result == null) result = caseSolver(solverJacop);
				if (result == null) result = caseSolutionProvider(solverJacop);
				if (result == null) result = caseSolverParams(solverJacop);
				if (result == null) result = caseRun(solverJacop);
				if (result == null) result = caseIGeneratorTool(solverJacop);
				if (result == null) result = caseSolutionProviderParams(solverJacop);
				if (result == null) result = caseRunParams(solverJacop);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Solver Jacop</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Solver Jacop</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSolverJacop(SolverJacop object) {
		return null;
	}

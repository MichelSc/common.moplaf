 ...
 * @generated
 */
public class SerializeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SerializePackage.SERIALIZABLE: {
				...
				if (result == null) result = caseFileHandler(serializable);
				if (result == null) result = caseFileOwner(serializable);
			...
			case SerializePackage.DESERIALIZABLE: {
				...
				if (result == null) result = caseFileHandler(deserializable);
				if (result == null) result = caseFileOwner(deserializable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Deserializable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Deserializable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDeserializable(Deserializable object) {
		return null;
	}

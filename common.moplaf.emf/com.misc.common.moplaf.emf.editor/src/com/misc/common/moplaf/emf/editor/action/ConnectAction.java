...
/**
 * A accept action  is implemented by creating a {@link ConnectCommand}.
 */
public class ConnectAction extends CommandAction
{
	public final static String ID = "com.misc.common.moplaf.emf.editor.action.Connect";
	/**
	 ...
	 * @since 2.4.0
	 */
	public ConnectAction(IWorkbenchPart part, ISelection selection)
	{
	...
	protected Command createActionCommand(EditingDomain editingDomain, Collection<?> collection)
	{
		if (collection.size() == 1)
		{
			...
			return ConnectCommand.create(editingDomain, owner);
		}

 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.common.moplaf.common.impl.JobParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.misc.common.moplaf.common.impl.JobParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.misc.common.moplaf.common.impl.JobParameterImpl#getJobAttribute <em>Job Attribute</em>}</li>
 *   <li>{@link com.misc.common.moplaf.common.impl.JobParameterImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JobParameterImpl extends MinimalEObjectImpl.Container implements JobParameter {
	...
	protected EClass eStaticClass() {
		return CommonPackage.Literals.JOB_PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.JOB_PARAMETER__NAME, oldName, name));
	}
	...
	public void setType(JobParameterType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.JOB_PARAMETER__TYPE, oldType, type));
	}
	...
	public EAttribute getJobAttribute() {
		if (jobAttribute != null && jobAttribute.eIsProxy()) {
			...
			if (jobAttribute != oldJobAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommonPackage.JOB_PARAMETER__JOB_ATTRIBUTE, oldJobAttribute, jobAttribute));
			}
		}
		return jobAttribute;
	}
	...
	public void setJobAttribute(EAttribute newJobAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.JOB_PARAMETER__JOB_ATTRIBUTE, oldJobAttribute, jobAttribute));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.JOB_PARAMETER__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommonPackage.JOB_PARAMETER__NAME:
				return getName();
			case CommonPackage.JOB_PARAMETER__TYPE:
				return getType();
			case CommonPackage.JOB_PARAMETER__JOB_ATTRIBUTE:
				if (resolve) return getJobAttribute();
				return basicGetJobAttribute();
			case CommonPackage.JOB_PARAMETER__DESCRIPTION:

 ...
 * @generated
 */
public class DatasetLoadDerbyItemProviderAdapterFactory extends DatasetLoadDerbyAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	/**
	 ...
	 * @generated
	 */
	public DatasetLoadDerbyItemProviderAdapterFactory() {
	...
	public Adapter createDataSourceJdbDerbyEmbeddedAdapter() {
		if (dataSourceJdbDerbyEmbeddedItemProvider == null) {
			dataSourceJdbDerbyEmbeddedItemProvider = new DataSourceJdbDerbyEmbeddedItemProvider(this);
		}

		return dataSourceJdbDerbyEmbeddedItemProvider;
	}
	 ...
	 */
	public void dispose() {
		if (dataSourceJdbDerbyEmbeddedItemProvider != null) dataSourceJdbDerbyEmbeddedItemProvider.dispose();
	}

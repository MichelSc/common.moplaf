 ...
 * @generated
 */
public class DbsynchjtdsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DbsynchjtdsPackage.DATA_SOURCE_JDBC_JTDS: {
				DataSourceJdbcJtds dataSourceJdbcJtds = (DataSourceJdbcJtds)theEObject;
				T result = caseDataSourceJdbcJtds(dataSourceJdbcJtds);
				if (result == null) result = caseDataSourceJdbc(dataSourceJdbcJtds);
				if (result == null) result = caseDataSource(dataSourceJdbcJtds);
				if (result == null) result = caseDbSynchUnitAbstract(dataSourceJdbcJtds);

...
import com.misc.common.moplaf.propagator2.util.PropagatorFunctionVisitor;
...
//		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case PropagatorPackage.PROPAGATOR_FUNCTION___NOTIFY_CHANGED_OBJECT__NOTIFICATION:
				notifyChangedObject((Notification)arguments.get(0));
				return null;

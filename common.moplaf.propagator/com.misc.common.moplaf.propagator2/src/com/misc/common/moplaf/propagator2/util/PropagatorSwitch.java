...
public class PropagatorSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PropagatorPackage.OBJECT_WITH_PROPAGATOR_FUNCTIONS: {
				ObjectWithPropagatorFunctions objectWithPropagatorFunctions = (ObjectWithPropagatorFunctions)theEObject;
				T result = caseObjectWithPropagatorFunctions(objectWithPropagatorFunctions);
			...
			case PropagatorPackage.PROPAGATOR_FUNCTION_BINDINGS: {
				PropagatorFunctionBindings propagatorFunctionBindings = (PropagatorFunctionBindings)theEObject;
				T result = casePropagatorFunctionBindings(propagatorFunctionBindings);
				if (result == null) result = casePropagatorFunction(propagatorFunctionBindings);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

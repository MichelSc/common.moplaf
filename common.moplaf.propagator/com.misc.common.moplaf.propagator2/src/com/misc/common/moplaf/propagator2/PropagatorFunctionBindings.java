 ...
 * and call {@link PropagatorFunctionBindings#touch} when some change in the bound 
 * feature occurred.
 * <p>
 ...
 * <p>
 * Registering the {@link PropagatorFunctionBindings}s is done by the method 
 ...
 *
 */
	public class PropagatorFunctionBindings extends AdapterImpl implements PropagatorFunctionSource{
	...
	// -------------------------------------
	public PropagatorFunctionBindings(Bindings bindings) {
		super();
	...
	void addDependency(Bindings bindings, Notifier target){
		...
		PropagatorFunctionBindings dependency = (PropagatorFunctionBindings) Util.getAdapter(target, bindings);
	...
	PropagatorFunctionBindings removeDependency(Bindings bindings, Notifier target){
		PropagatorFunctionBindings dependency = (PropagatorFunctionBindings) Util.getAdapter(target, bindings);
		if ( dependency != null){
